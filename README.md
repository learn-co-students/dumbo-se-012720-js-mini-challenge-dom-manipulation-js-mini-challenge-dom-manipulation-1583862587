...
**YOUR NOTES**
```
Stuck in a "defer" like Ian showed us in lecture
```
...
**YOUR NOTES**
```
Just had to get the syntax from yesterday's lab
```
...
**YOUR NOTES**
```
Just used Ian's lecture code from today 
```
